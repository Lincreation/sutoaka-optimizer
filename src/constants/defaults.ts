...
const MEMBER_SLACK_NAME_MAP: Record<string, string> = {
  'member_001': 'MIYA',
  'member_002': 'yui',
  'member_003': '大木雄太',
  'member_004': 'Nobo',
  'member_005': 'yasushi caffeine',
  'member_006': 'ゆゆ',
  'member_007': 'よっしー',
  'member_008': 'みぃぴこ',
  'member_009': '小川',
  ...
  'member_013': 'reina',
  'member_014': 'YUN',
  'member_015': 'Takao Koyanagi',
  'member_016': '荻野賀子',
  'member_017': '茜（あかね）',
  'member_018': '井口聡/ぽんぽこAI',
  'member_019': 'natsumi',
  'member_020': 'Bean（AI講師）',
  'member_021': '小幡愛実(アシスタント)',
  'member_022': 'Keiko',
  'member_023': 'クニサダ',
  'member_024': 'クーちゃん',
  'member_025': 'なちこ',
  ...
  'member_033': 'あこ',
  'member_034': 'のむ',
  'member_035': '竹内/みんなの先生',
  'member_036': 'Mine',
  'member_037': '',
  'member_038': 'たいたい',
  'member_039': '野口',
  'member_040': 'ゆーこ',
  'member_041': 'syusui3232',
};
...
export const DEFAULT_MEMBERS: Member[] = MEMBER_NAMES.map((name, i) => {
  ...
  return {
    ...
    slackName: MEMBER_SLACK_NAME_MAP[id] ?? '',
